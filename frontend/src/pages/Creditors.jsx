...
export default function Creditors() {
  ...
  return (
    <div className="page">
      ...
      <Table columns={columns} rows={filtered} loading={listLoading} loadingText="Loading creditors…" emptyText={query ? 'No creditors match your search.' : 'No creditors recorded yet.'} />
